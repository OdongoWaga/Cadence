...
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;backface-visibility:hidden;}.count-enter{transform:rotateX('0.5turn');}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{transform:rotateX('0.5turn');}"]); //To make sure the fonts are all the same width
...
//# sourceMappingURL=_app.js.bcdff147032799d1bc73.hot-update.js.map